...
const Registration = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-6 md:p-12 relative overflow-hidden bg-cream selection:bg-coral selection:text-white">
      ...
      <div className="bg-surface/90 backdrop-blur-xl w-full max-w-md p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-glass-border/50 hover:shadow-[0_8px_30px_rgba(244,81,95,0.1)] transition-all duration-500 relative z-10">
